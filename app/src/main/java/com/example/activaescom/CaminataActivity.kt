...
class CaminataActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val rutinaNombre       = intent.getStringExtra("NOMBRE_RUTINA")        ?: "Caminata Individual"
        val metaDistancia      = intent.getStringExtra("META_DISTANCIA")       ?: "3.0 km"
        val horasSueno         = intent.getIntExtra("HORAS_SUENO", 7)
        val lugarSeleccionado  = intent.getStringExtra("LUGAR_ENTRENAMIENTO")  ?: "Parque"
