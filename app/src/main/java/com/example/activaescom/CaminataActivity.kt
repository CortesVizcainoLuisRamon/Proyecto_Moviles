...
class CaminataActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun cargarDatosConfiguracion() {
        ...
        tvConfigRutinaTitulo.text = intent.getStringExtra("NOMBRE_RUTINA") ?: "Caminata Individual"
        tvConfigMeta.text = "Meta: ${intent.getStringExtra("META_DISTANCIA") ?: "3.0 km"}"
        tvConfigSueno.text = "💤 : ${intent.getIntExtra("HORAS_SUENO", 7)} hrs"
        tvConfigLugar.text = "📍 : ${intent.getStringExtra("LUGAR_ENTRENAMIENTO") ?: "Parque"}"
